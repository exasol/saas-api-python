...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v1/accounts/{account_id}/databases/{database_id}/clusters/{cluster_id}/start".format(account_id=quote(str(account_id), safe=""),database_id=quote(str(database_id), safe=""),cluster_id=quote(str(cluster_id), safe=""),),
    }
