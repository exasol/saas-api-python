...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/accounts/{account_id}/databases/{database_id}/folder/{key}".format(account_id=quote(str(account_id), safe=""),database_id=quote(str(database_id), safe=""),key=quote(str(key), safe=""),),
    }
