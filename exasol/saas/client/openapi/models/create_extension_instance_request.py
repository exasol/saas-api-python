...
T = TypeVar("T", bound="CreateExtensionInstanceRequest")


@_attrs_define
class CreateExtensionInstanceRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_extension_instance_request = cls(
            parameter_values=parameter_values,
        )

        return create_extension_instance_request
